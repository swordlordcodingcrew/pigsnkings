...
<tileset version="1.4" tiledversion="1.4.3" name="items" tilewidth="32" tileheight="48" tilecount="53" columns="53">
 <image source="../../gfx/common/items/items.png" trans="ff00ff" width="1696" height="48"/>
 <tile id="0" type="coin_silver">
  <properties>
   <property name="name" value="silvercoin"/>
  </properties>
  <animation>
